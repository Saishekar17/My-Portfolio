...
import image1 from 'public/sairdy.JPG'
import image2 from 'public/aiImg2.jpg'
import image3 from 'public/sai.jpg'
import image4 from 'public/aiImg.jpg'
import image5 from '@/images/logos/royal.png'
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Sai Shekar - Leader and software engineer</title>
        <meta
          name="title"
          content="Sai Shekar - Full Stack Developer/Software Engineer "
        />
        <meta
          name="description"
          content="I'm Sai Shekar, full stack developer/software engineer. I'm from India 🇮🇳, Hyderabad. I am on my journey to exploring the world of Softwares and AI."
        />
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software Engineer and AI Enthusiast in India, Hyderabad.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          👋I am Sai Shekar, full stack developer/software engineer. I am from India 🇮🇳, Hyderabad. I am on my journey to exploring the world of Softwares and AI.
          </p>
