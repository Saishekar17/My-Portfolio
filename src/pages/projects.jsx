...
const projects = [
  {
    name: 'Easy Travel Booking: embark on unforgettable adventures and explore the world like never before',
    description:
      "Developed with Next.js, React, and Tailwind CSS for optimal UI/UX. Utilizes Vercel, Buildspace, and with designs in Figma and version control via GitHub.",
    link: {
      href: 'https://easytravelbooking.netlify.app',
      label: 'Link',
    },
    logo: logoOpenShuttle,
  },
  {
    name: 'AI ChatBot: Instant response',
    description:
      'Crafted with stunning UI and built with Next.js and Tailwind CSS for dynamic, responsive design. Optimized on Vercel and Replicate API integration for seamless user experience. while Google API enhances security for user authentication.',
    link: {
      href: 'https://ai-chat-bot-instant-responses.vercel.app',
      label: 'Link',
    },
    logo: orb,
  },
  {
    ...
    description:
      "Crafted with next.js . Unveiled the innovative Image Describer, providing users with curated GPT-generated content. Built using Next.js, Tailwind CSS, and integrated with PicoLabs for dynamic content generation.",
    link: { href: 'https://ai-image-genarator-eight.vercel.app', label: 'Link' },
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Sai shekar</title>
        <meta
          name="description"
