...
export default function Speaking() {
  return (
    ...
    <div className='flex items-center justify-center mt-20 text-3xl'>
     <h1 className='dark:text-white'> For Exprience Visit projects Page for my <span className='font-bold underline'>Projects</span> </h1> 
     </div>
    </>
  )
} 
...
/* <Head>
<title>Experience - Sai Shekar</title>
<meta
  name="description"
...
intro="Embarking on a path filled with innovation, leadership, and development, my career in technology spans various roles and achievements. Here's a glimpse into my projects."
>
